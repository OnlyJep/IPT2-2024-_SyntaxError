...
document.addEventListener('DOMContentLoaded', () => {
    ...
    leftDiv.style.backgroundSize = 'cover'; // Cover the entire div
    leftDiv.style.backgroundPosition = 'center'; // Center the background image
    leftDiv.style.display = 'flex';
    leftDiv.style.justifyContent = 'center';
    leftDiv.style.alignItems = 'center';
    leftDiv.style.height = '100vh'; // Full height of the viewport
